...
@immutable
class _JustinoIconsFruitsData extends IconData {
  const _JustinoIconsFruitsData(int codePoint)
      : super(
          codePoint,
          fontFamily: 'JustinoIconsFruits',
        );
}
...
class JustinoIconsFruits {
  ...
  IconData getByName(String name) => iconsMap[name] ?? appleFruits;
