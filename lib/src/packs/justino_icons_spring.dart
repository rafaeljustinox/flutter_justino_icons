...
@immutable
class JustinoIconsSpring {
  const JustinoIconsSpring();

  List<IconData> get all => this.iconsMap.keys.map((key) => this.iconsMap[key]!).toList();

  IconData getByName(String name) => iconsMap[name] ?? bbqSpring;
  ...
  Map<String, IconData> get iconsMap => { 
    ...
    'clover' : clover,
    'easterEgg' : easterEgg,
    'fenceSpring' : fenceSpring,
    'floods' : floods,
    'flowerBud' : flowerBud,
    'flowerPot' : flowerPot,
    'flower' : flower,
    'germinate' : germinate,
    'glovesSpring' : glovesSpring,
    'grass' : grass,
    'gumboot' : gumboot,
    'icicles' : icicles,
    ...
    'pinwheel' : pinwheel,
    'radish' : radish,
    'rainSpring' : rainSpring,
    'rake' : rake,
    'seeds' : seeds,
    'shovel' : shovel,
    'springSpring' : springSpring,
    'sprout' : sprout,
    'stormSpring' : stormSpring,
    'sunSpring' : sunSpring,
    'treeSpring' : treeSpring,
    'umbrellaSpring' : umbrellaSpring,
    'waterHose' : waterHose,
