...
class JustinoIconsSports {
  ...
  IconData getByName(String name) => iconsMap[name] ?? badminton;

  Map<String, IconData> get iconsMap => { 
    'badminton' : badminton,
    'baseballBall' : baseballBall,
    'basketballBall' : basketballBall,
    'basketballJersey' : basketballJersey,
    ...
    'medalSports' : medalSports,
    'pingPong' : pingPong,
    'rugbyBall' : rugbyBall,
    'scoreboard' : scoreboard,
    'smartwatch' : smartwatch,
    'sport' : sport,
    'stopwatchSports' : stopwatchSports,
    'swimmingPoolSports' : swimmingPoolSports,
    'tShirt' : tShirt,
