...
class JustinoIconsDelivery {
  ...
  Map<String, IconData> get iconsMap => { 
    ...
    'doNotRoll' : doNotRoll,
    'doNotUseHooks' : doNotUseHooks,
    'flammableSign' : flammableSign,
    'giftDelivery' : giftDelivery,
    'handTruck' : handTruck,
    'handleWithCare' : handleWithCare,
    'importantDelivery' : importantDelivery,
    'loading' : loading,
    ...
    'railwayDelivery' : railwayDelivery,
    'receipt' : receipt,
    'returnBox' : returnBox,
    'thisSideUp' : thisSideUp,
    'tilt' : tilt,
    'tracking' : tracking,
    'trolleyDelivery' : trolleyDelivery,
    'unloading' : unloading,
    'view' : view,
