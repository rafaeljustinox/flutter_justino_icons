...
class JustinoIconsSailor {
  ...
  IconData getByName(String name) => iconsMap[name] ?? anchorSailor;
  ...
  Map<String, IconData> get iconsMap => { 
    ...
    'logbook' : logbook,
    'mapSailor' : mapSailor,
    'mooringBollard' : mooringBollard,
    'oars' : oars,
    'oxygenTank' : oxygenTank,
    'periscope' : periscope,
    'portholeSailor' : portholeSailor,
    'radar' : radar,
    'reefKnot' : reefKnot,
    'rum' : rum,
    'screw' : screw,
    ...
    'singlet' : singlet,
    'smoke' : smoke,
    'tridentSailor' : tridentSailor,
    'wave' : wave,
    'windsockSailor' : windsockSailor,
    'woman' : woman,
    'woodRaft' : woodRaft,
  };
