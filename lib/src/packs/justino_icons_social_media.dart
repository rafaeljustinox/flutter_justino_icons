...
class JustinoIconsSocialMedia {
  ...
  Map<String, IconData> get all => { 
    ...
    'chatSocialMedia' : chatSocialMedia,
    'comments' : comments,
    ...
    'keyboardSocialMedia' : keyboardSocialMedia,
    'laptopSocialMedia' : laptopSocialMedia,
    'likeSocialMedia' : likeSocialMedia,
    'link' : link,
    'message' : message,
    'monitor' : monitor,
    'newsSocialMedia' : newsSocialMedia,
    ...
    'selfie' : selfie,
    'smartphoneSocialMedia' : smartphoneSocialMedia,
    'socialNetwork' : socialNetwork,
    'surprised' : surprised,
    'thumbsUp' : thumbsUp,
    'userSocialMedia' : userSocialMedia,
    'videoPlayerSocialMedia' : videoPlayerSocialMedia,
    'video' : video,    
  };
